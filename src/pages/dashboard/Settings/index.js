...
import ThemeDialog from '../../../sections/Dashboard/SettingsDashborad/ThemeDialog';
import ShortcutDialog from '../../../sections/Dashboard/SettingsDashborad/ShortcutDialog';
    ...
    return (
        <>
            <Stack direction="row" sx={{ width: "100%" }}>
                {/* LeftPane */}
                <Box sx={{ ...scrollingStyles, height: "100vh", width: 320, backgroundColor: theme.palette.mode === "light" ? "#F8FAFF" : theme.palette.background, boxShadow: "0px 0px 2px rgba(0, 0, 0, 0.25)", }}   >
                    <Stack p={4} spacing={5}>
                        {/* Header */}
                ...
                {/* Right Pane */}
                <Box sx={{ height: "100%", width: "calc(100vw - 420px )", backgroundColor: theme.palette.mode === "light" ? "#FFF" : theme.palette.background.paper, borderBottom: "6px solid #0162C4", }} >
                </Box>
            </Stack>
