...
const CreateGroupForm = ({ handleClose }) => {
    ...
    const defaultValues = { title: "", tags: [], };
    ...
    return (
        <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
            <Stack spacing={3}>
                ...
                <RHFAutocomplete name="members" label="Members" multiple freeSolo options={TAGS_OPTION.map((option) => option)} ChipProps={{ size: "medium" }} />
